...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Fastpay IT Solution Ltd | Payments, POS & Web" },
      {
        name: "description",
        content:
          "Fastpay IT Solution Ltd delivers payment gateway integration, POS systems and website development for growing businesses.",
      },
      { name: "author", content: "Fastpay IT Solution Ltd" },
